...
async def get_thumb(videoid):
    ...
    font = ImageFont.truetype("AarohiX/assets/font.ttf", 30)
    title_font = ImageFont.truetype("AarohiX/assets/font3.ttf", 45)
    ...
    draw.text((10, 10), f"KRISH MUSIC", fill="white", font=font)
