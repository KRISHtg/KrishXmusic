...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("ANNIEMUSIC/assets/Kr.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((1157, 1158))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('ANNIEMUSIC/assets/annie/ArialReg.ttf', size=110)
    welcome_font = ImageFont.truetype('ANNIEMUSIC/assets/annie/ArialReg.ttf', size=60)
